---
title: "Quarto Dashboards: Static Reporting"
description: "Created a static reproducible dashboard using Quarto for efficient data reporting."
author: 
  - name: Jacob Perez
    url: https://github.com/jacobperez-debug
    affiliation: Master of Science in Statistics @ Cal Poly SLO
date: 05-05-2025
image: lab3thumbnail.png
warning: false
message: false
code-fold: true
...
<iframe src="https://jacobperez.quarto.pub/trust-in-science-global-patterns--change/#trust-across-regions" width="100%" height="1000px">
